...
var addAndDelete = require('./database/addAndDelete');
...
app.use(express["static"](path.join(__dirname, 'public'))); //解决跨域
...
app.use('/api', addAndDelete); // catch 404 and forward to error handler
